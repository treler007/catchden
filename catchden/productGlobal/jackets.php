...
<a href="/productGlobal/hudi.php">Худи</a>
	...
	<a href="/productGlobal/jeackets.php">Куртки</a>
...
<?
                ...
                $search=$db->query("SELECT `name`,`price`,`link_img`,`id` FROM `products` WHERE `global_product_id`=3 ORDER BY `name` ");
                foreach($search as $row){?>
                    ...
                    <div class="productCard">
                        ...
                        <div id="name_product"><a href="/card-product?productid=<?echo $row['id']?>"><?echo $row['name']; ?></a></div>
