...
<div class="product_glav" id="searchPage2">
	...
	<?
                        ...
                        $search=$db->query("SELECT `name`,`price`,`link_img`,`id` FROM `products` WHERE `cat`=1 ORDER BY `name` ");
						foreach($search as $row){?>
						
							<div class="productCard">
							
								<div data-idproduct=<?echo $row['id']?> id="img_product"><img  src="/img/<?echo $row['link_img'];?>" alt=""></div>
